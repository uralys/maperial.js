...
function HeatRenderer ( mapView ) {
   ...
   this.texB         = null;
   this.tex          = [];
   this.cs           = new CoordinateSystem (256)
   this.initialResolution   = 2 * Math.PI * 6378137 / 256;
   this.originShift         = 2 * Math.PI * 6378137 / 2.0 ;
}

HeatRenderer.prototype.AllocBuffer = function ( sizeX , sizeY ) {
...
HeatRenderer.prototype.SetContext = function ( z , tileX, tileY, nbTX , nbTY ) {
...
HeatRenderer.prototype.Init = function ( data ) {
   if (this.tex.length > 0)
      return;
   this.data   = data;
}

HeatRenderer.prototype.Reset = function (  ) {
   var gl            = this.gl;
   this.layerCount   = 0
   if ( this.texB ) {
...
HeatRenderer.prototype.Release = function (  ) {
   this.Reset()
}

HeatRenderer.prototype.IsUpToDate = function ( ) {
   return this.layerCount == null;
}

HeatRenderer.prototype.Update = function ( params ) {
...
HeatRenderer.prototype.GetTex = function ( tx , ty ) {
   var i = tx - this.tx;
   var j = ty - this.ty;
...
HeatRenderer.prototype._BuildTexture = function ( params ) {
   var gltools       = new GLTools ()
   var gl            = this.gl;
