...
function CustomRenderer ( mapView ) {
...
CustomRenderer.prototype.AllocCanvas = function ( sizeX, sizeY) {
...
CustomRenderer.prototype.SetContext = function ( z , tileX, tileY, nbTX , nbTY ) {
...
CustomRenderer.prototype.Init = function ( data ) {
   if (this.tex.length > 0)
      return;
   this.data   = data;
}

CustomRenderer.prototype.Reset = function (  ) {
   var gl            = this.gl;
   this.layerCount   = 0
   if (this.cnv) {
      delete      this.cnv;
...
CustomRenderer.prototype.Release = function (  ) {
   this.Reset()
}

CustomRenderer.prototype.IsUpToDate = function ( ) {
   return this.layerCount == null;
}

CustomRenderer.prototype.Update = function ( params ) {
...
CustomRenderer.prototype.GetTex = function ( tx , ty) {
   var i = tx - this.tx;
   var j = ty - this.ty;
...
CustomRenderer.prototype._BuildTexture = function (  ) {
