   ...
   switch(params){
      case HUD.WMS_DATA:
         html += "" +
            ...
            "   <div class='span3 wms' title='Cantons de Bretagne' onclick='HUD.selectedData"+this.maperial.tagId+"(Source.WMS, Source.WMS_BRETAGNECANTONS)'>" +
            "     <img src='http://static.maperial.localhost/images/buttons/sources/button.wms.bretagnecantons.png' class='bigbutton'></img>" +
            "   </div>" +
            "   <div class='span3 wms' title='Cours d eau en France' onclick='HUD.selectedData"+this.maperial.tagId+"(Source.WMS, Source.WMS_FRANCECOURSDEAU)'>" +
            "     <img src='http://static.maperial.localhost/images/buttons/sources/button.wms.francecoursdeau.png' class='bigbutton'></img>" +
            "   </div>" +
            "   <div class='span3 wms' title='Ille et Vilaine : Unités Cartographiques de Sol' onclick='HUD.selectedData"+this.maperial.tagId+"(Source.WMS, Source.WMS_SOLS_ILEETVILAINE)'>" +
            "     <img src='http://static.maperial.localhost/images/buttons/sources/button.wms.sols_ileetvilaine.png' class='bigbutton'></img>" +
            "   </div>" +
            "   <div class='span3 wms' title='France : Occupation des sols' onclick='HUD.selectedData"+this.maperial.tagId+"(Source.WMS, Source.WMS_CORINE_LAND_COVER)'>" +
