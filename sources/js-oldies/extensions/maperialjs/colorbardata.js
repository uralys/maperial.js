...
ColorBarData.__globalColorbarCpt = 0

function ColorBarData ( uid ) {
   if ( typeof uid === "undefined") {
      uid = "0_customcolorbar_" + ColorBarData.__globalColorbarCpt
      ColorBarData.__globalColorbarCpt = ColorBarData.__globalColorbarCpt + 1
   }
   this.data         = {}
   this.uid          = uid
   this.aZeroB       = false
...
ColorBarData.prototype.Uid = function() {
   return this.uid
}

ColorBarData.prototype.BeginWithAlphaZero = function ( activated ) {
   this.aZeroB       = activated
}
